...
<template>
  <div
    class="flex flex-col items-center content-center align-middle place-content-center h-screen bg-slate-600 text-gray-700">
      ...
      <Form @submit="onSubmit" :validation-schema="schema" v-slot="{ errors }">
        <div class="form-group flex flex-col mb-2">
          ...
          <Field name="username" type="text" class="form-control"
            :class="{ 'border-2 border-rose-500': errors.username }" />
        ...
        <div class="form-group flex flex-col mb-2">
          ...
          <Field name="password" type="password" class="form-control"
            :class="{ 'border-2 border-rose-500': errors.password }" />
